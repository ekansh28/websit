      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {services.map((service) => (
            <Card key={service.name} className="bg-card border-border/50 text-center flex flex-col items-center justify-center p-4 md:p-6 transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/10">
